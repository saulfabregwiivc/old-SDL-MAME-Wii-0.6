...
#	Use make SUBTARGET=mini to build
#
...
DRVLIBS = \
	$(MAMEOBJ)/mini.o $(MAMEOBJ)/exidy.a $(MAMEOBJ)/gaelco.a \
	$(MAMEOBJ)/pacman.a $(MAMEOBJ)/konami.a $(MAMEOBJ)/namco.a \
	$(MAMEOBJ)/nichibut.a $(MAMEOBJ)/nintendo.a $(MAMEOBJ)/univers.a $(MAMEOBJ)/cvs.a \
	$(MAMEOBJ)/capcom.a $(MAMEOBJ)/rare.a $(MAMEOBJ)/midway.a $(MAMEOBJ)/toaplan.a \
	$(MAMEOBJ)/dataeast.a $(MAMEOBJ)/tehkan.a $(MAMEOBJ)/atari.a $(MAMEOBJ)/phoenix.a \
	$(MAMEOBJ)/taito.a $(MAMEOBJ)/meadows.a $(MAMEOBJ)/midw8080.a $(MAMEOBJ)/technos.a \
	$(MAMEOBJ)/sega.a $(MAMEOBJ)/seibu.a $(MAMEOBJ)/misc.a $(MAMEOBJ)/shared.a \
