...
SDL_INSTALL_ROOT = $(DEVKITPRO)/libogc
endif
...
OSDOBJS =  $(SDLOBJ)/sdlmain.o \
	...
	$(SDLOBJ)/drawgx.o $(SDLOBJ)/window.o $(SDLOBJ)/output.o 
#	$(SDLOBJ)/drawsdl.o $(SDLOBJ)/window.o $(SDLOBJ)/output.o 


# if SDL-Wii ever upgrades to 1.3, uncomment this
...
LIBS += -lm -L$(SDL_INSTALL_ROOT)/lib/wii $(LIBGL)
endif
